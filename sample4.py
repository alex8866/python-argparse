...
parser.add_argument('-c', action = 'store_const', dest = 'constant_value', const = 'value-to-store', help = 'Store a constant value') # 相当于做了一个标记
...
print 'boolean_switch =', results.boolen_switch
print 'collection =', results.collection
print 'collection_constant =', results.const_collection
